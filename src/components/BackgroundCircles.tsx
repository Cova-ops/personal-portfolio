...
const BackgroundCircles = (props: Props) => {
  return (
    <motion.div
      ...
      <div className='rounded-full border border-[#333333] h-[300px] w-[300px] absolute mt-32' />
      <div className='rounded-full border border-[#333333] h-[500px] w-[500px] absolute mt-32' />
